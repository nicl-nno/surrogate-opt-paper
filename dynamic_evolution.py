...
from src.evolution.spea2dyn import SPEA2Dyn
...
def optimize_dynamic_test(train_stations, max_gens, pop_size, archive_size, crossover_rate, mutation_rate,
    ...
    history, archive_history = SPEA2Dyn(
...
if __name__ == '__main__':
    optimize_dynamic_test(train_stations=[1, 2, 3], max_gens=30, pop_size=30, archive_size=10,
